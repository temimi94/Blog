...
START TRANSACTION;
USE `blog`;
INSERT INTO `blog`.`comment` (`id_comment`, `id_article`, `content`, `date`, `date_update`, `id_user`) VALUES (DEFAULT, 1, 'Super Article', '2019-12-12 01:05:06', NULL, 2);
INSERT INTO `blog`.`comment` (`id_comment`, `id_article`, `content`, `date`, `date_update`, `id_user`) VALUES (DEFAULT, 2, 'Article émouvant', '2019-12-12 02:06:07', NULL, 2);
INSERT INTO `blog`.`comment` (`id_comment`, `id_article`, `content`, `date`, `date_update`, `id_user`) VALUES (DEFAULT, 3, 'Mauvais Article', '2019-12-12 03:04:08', NULL, 1);
